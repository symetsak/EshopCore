...
namespace Eshop.Infrastructure.Migrations.ApplicationDb
{
    ...
    [Migration("20260702083628_MakeCustomerIdNullableInNotifications")]
    partial class MakeCustomerIdNullableInNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eshop.Core.Entities.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("MinimumSubTotalRequired")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Eshop.Core.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Eshop.Core.Entities.OrderReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Eshop.Core.Entities.OrderReturnItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Eshop.Core.Entities.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Eshop.Core.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Eshop.Core.Entities.User", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Eshop.Core.Entities.OrderReturnItem", b =>
                {
                    b.HasOne("Eshop.Core.Entities.OrderReturn", "OrderReturn")
