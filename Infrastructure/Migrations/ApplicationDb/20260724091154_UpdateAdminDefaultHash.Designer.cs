...
namespace Eshop.Infrastructure.Migrations.ApplicationDb
{
    ...
    [Migration("20260724091154_UpdateAdminDefaultHash")]
    partial class UpdateAdminDefaultHash
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$OPxsghdegmQpE7W5Vm9weuKIafu4GGVyh5E4W.Hkr2gdWrTdzvpqm",
                            PhoneNumber = "",
                            Role = "Administrator",
                            Username = "admin"
                        });
